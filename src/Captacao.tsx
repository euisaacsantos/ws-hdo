  ...
  return (
    <div className="min-h-screen bg-brand-navy text-brand-text font-sans selection:bg-brand-gold selection:text-brand-navy">
      ...
      <div className="bg-white border-b border-[#081E3B]/10 py-3 md:py-3 px-4 text-xs md:text-sm tracking-widest uppercase z-50 relative">
        <div className="max-w-[360px] md:max-w-[1140px] mx-auto flex flex-col md:flex-row items-center justify-center gap-1 md:gap-6">
          <div className="flex flex-row items-center justify-center gap-2 md:gap-6">
            <span className="text-[11px] md:text-[16px] font-bold text-[#081E3B] flex items-center gap-1 md:gap-2">
              <img src="/assets/CALENDARIO GOLD.svg" alt="" className="h-[11px] md:h-[16px] w-auto" />
              28 e 29 de março
            </span>
            <span className="text-[#081E3B]/30">|</span>
            <div className="flex items-center gap-1 md:gap-2 text-[11px] md:text-[16px] font-bold text-[#081E3B]">
              <img src="/assets/PLAY GOLD.svg" alt="" className="h-[11px] md:h-[16px] w-auto" />
              100% ao vivo
            </div>
            <span className="hidden md:inline text-[#081E3B]/30">|</span>
          </div>
          <div className="flex items-center gap-1 md:gap-2 text-[11px] md:text-[16px] font-bold">
            <span className="text-brand-gold md:hidden">Inscrições encerram em</span>
            <span className="hidden md:inline text-brand-gold">Inscrições encerram em</span>
            <span className="text-[#081E3B] bg-[#081E3B]/10 px-2 md:px-3 py-1 rounded-md">{formatTime(timeLeft.days)}d : {formatTime(timeLeft.hours)}h : {formatTime(timeLeft.minutes)}m : {formatTime(timeLeft.seconds)}s</span>
          </div>
        </div>
      </div>
      ...
      <main className="relative z-10 [&>section+section]:mt-0">
        ...
        {/* 1a DOBRA - Hero com Formulario */}
        <section className="pt-[190px] md:pt-10 pb-12 md:pb-10 px-6 bg-white bg-[url('/assets/BG1%20MOBILE%202.png')] bg-cover bg-[center_top_-10px] bg-no-repeat md:bg-[url('/assets/BG1%20DESKTOP%202.png')] md:bg-cover md:bg-center md:bg-no-repeat relative">
          ...
          <div className="max-w-[360px] md:max-w-[1140px] mx-auto text-center md:text-left flex flex-col items-center md:items-start">
            <img src="/assets/LOGO HDO AZUL.svg" alt="Workshop A Habilidade de Ouro" className="mb-6 h-16 w-auto hidden md:block" />

            <h1 className="text-[26px] md:text-[36px] font-serif text-white md:text-[#081E3B] leading-[1.0] mb-3 max-w-4xl">
            ...
            <p className="text-[16px] md:text-[18px] text-white md:text-[#081E3B]/70 max-w-3xl mb-4 leading-[1.3] font-light">
              Em um <strong className="font-bold text-white md:text-[#081E3B]">treinamento de dois dias</strong> você desenvolverá<span className="hidden md:inline"><br/></span> a habilidade que nenhuma faculdade te ensinou, mas<span className="hidden md:inline"><br/></span> que é determinante para o seu sucesso:<span className="hidden md:inline"><br/></span> <strong className="font-bold text-white md:text-[#081E3B]">a habilidade de destravar pessoas.</strong>
            </p>

            {/* Formulario inline */}
            <div className="w-full md:max-w-[540px] bg-[#081E3B]/80 backdrop-blur-md rounded-xl px-5 py-5 md:px-6 md:py-6 border border-white/10">
              <form onSubmit={handleSubmit} className="space-y-3.5">
                <div>
                  <label className="hidden md:block text-xs text-white/60 mb-1 font-sans text-left">Nome</label>
                  <input
                    type="text"
                    required
                    value={formNome}
                    ...
                    className="w-full px-4 py-3.5 border border-[#CED2D8] rounded-lg text-[15px] text-gray-800 bg-white outline-none focus:border-brand-gold transition-colors placeholder:text-gray-400"
                  />
                </div>
                <div>
                  <label className="hidden md:block text-xs text-white/60 mb-1 font-sans text-left">E-mail</label>
                  <input
                    type="email"
                    required
                    value={formEmail}
                ...
                <div>
                  <label className="hidden md:block text-xs text-white/60 mb-1 font-sans text-left">WhatsApp</label>
                  <PhoneInput value={formPhone} onChange={setFormPhone} />
                </div>
                <button
                  type="submit"
                  disabled={formLoading}
                  className="w-full bg-gradient-to-r from-[#966E16] to-[#D6B865] hover:from-[#7d5c12] hover:to-[#c4a855] text-white px-6 py-4 rounded-lg font-bold text-[12px] md:text-[15px] transition-all duration-300 transform hover:scale-105 shadow-[0_0_50px_rgba(207,168,97,0.5),0_0_100px_rgba(207,168,97,0.25)] flex items-center justify-center gap-2 uppercase tracking-normal md:tracking-wider disabled:opacity-70 cursor-pointer"
                >
                  {formLoading ? 'Confirmando...' : 'GARANTIR MINHA VAGA GRATUITA'}
                </button>
              </form>
            </div>
          </div>
        ...
        {/* 2a DOBRA - A Verdade */}
        <section className="py-12 md:pt-10 md:pb-20 px-6 bg-white md:bg-[url('/assets/BG%20BASE%20CLARA%201%20DESKTOP.png')] md:bg-cover md:bg-center md:bg-no-repeat">
