...
export default async function handler(req, res) {
  ...
  const userData = {
    ...
    ...(user_data_client?.em && { em: [sha256(user_data_client.em)] }),
    ...(user_data_client?.ph && { ph: [sha256(user_data_client.ph.replace(/[^0-9]/g, ''))] }),
    ...(user_data_client?.fn && { fn: [sha256(user_data_client.fn.split(' ')[0])] }),
    ...(city && { ct: [sha256(city)] }),
